...
if __name__=="__main__":
    ...
    if console_flags.dec_dim is None:
        workbook.save(os.path.join(basedir, "resultmmdrandom","{}-sn{}-cs{}.xlsx".format(exp_id, min_samples, min_cluster_size)))
    else:
        workbook.save(os.path.join(basedir, "resultmmdrandom","{}-sn{}-cs{}-dim{}.xlsx".format(exp_id, min_samples,
                                                                                          min_cluster_size,
