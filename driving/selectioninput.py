# Clustering with different features
import hdbscan
...
if __name__=="__main__":
    ...
    # dense_output1 = preprocessing.normalize(dense_output1)
    ...
    if console_flags.dec_dim is None:
        workbook.save(os.path.join(basedir, "resultfeature", "{}-ft{}.xlsx".format(exp_id, select_layer_idx)))
    else:
        workbook.save(os.path.join(basedir, "resultfeature", "{}-ft{}-dim{}.xlsx".format(exp_id, select_layer_idx,
